...
contract ERC777 is Context,IERC777,IERC20{
    ...
    function totalSupply9()public view virtual override(IERC20,IERC777)returns(uint256){
        return _totalSupply;
    }
    ...
    function _move(address operator,address from,address t ,uint256 amount,bytes memory userData,bytes memory operatorData)private{
